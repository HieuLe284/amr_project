...
#  AutonomousExploration — ROS2 Node thực hiện Frontier + A* + DWA
#  Node này nhận map từ /map topic (do slam_robot publish) và thực hiện
#  exploration từ autonomous_exploration.
...
def generate_launch_description():
    ...
    # 4. Chạy node autonomous_exploration (Frontier + A* + DWA, nhận /map từ slam_robot)
